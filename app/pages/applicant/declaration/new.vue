...
<template>
  <div class="max-w-3xl mx-auto">
    ...
    <div
      ...
      class="p-6 bg-card rounded-lg border text-center"
    >
      ...
      <NuxtLink
        ...
        class="inline-block px-6 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition-colors"
      >
        Complete Profile
      </NuxtLink>
    </div>
    ...
    <div
      v-else-if="createdDeclaration"
      class="p-8 bg-card rounded-lg border"
    >
      ...
      <div class="flex items-center justify-between">
        ...
        <button
          type="button"
          :disabled="isLoading"
          class="px-6 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 disabled:opacity-50 transition-colors"
          @click="handleSubmit"
        >
    ...
    <div v-else class="p-8 bg-card rounded-lg border">
      <div class="text-center mb-8">
        <h1 class="text-2xl font-bold text-foreground mb-2">New Asset Declaration</h1>
